...
import { themeCommonElements } from "../../themeConfig";
...
const styles = theme => ({
    ...
    menuButton: {
        ...
        minWidth: 64,
        color: theme.palette.menuButtonColor,
        textTransform: "none",
        backgroundColor: theme.palette.paperColor,
        fontSize: 16,
        fontWeight: 600,
        '&:hover': {
            backgroundColor: theme.isOldDesign ? theme.palette.paperColor : theme.palette.menuButtonColor,
            color: theme.isOldDesign ? theme.palette.menuButtonColor : theme.palette.paperColor,
        },
        '&:active': {
            backgroundColor: theme.isOldDesign ? theme.palette.paperColor : theme.palette.menuButtonColor,
            color: theme.isOldDesign ? theme.palette.menuButtonColor : theme.palette.paperColor,
                ...
                <div className={classes.menuAndBanner}>
                    <MenuButton classes={classes} setSidebarVisibility={setSidebarVisibility} isSidebarOpen={isSidebarOpen} />
                    {
                        !isPageHasPatientBanner &&
                            <div className={classes.patientBannerPanel}>
                                <PatientBanner
                                    location={location}
                                    classes={classes}
...
export default connect(mapStateToProps, mapDispatchToProps)(withRouter(withStyles(styles)(LowPart)));