...
const convertPatientsHTTPResponse = (response, type, resource, params) => {
    switch (type) {
        ...
        case UPDATE:
            ...
            newData.address = [newAddressLine, newCity].join(' ');
            newData.totalAddress = [newAddressLine, newCity].join(' ');
            return {
        ...
        case CREATE:
            ...
            let newAddress = get(params, 'data.address', null) + ' ' + get(params, 'data.city', null);
