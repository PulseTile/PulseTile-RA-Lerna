...
**Showcase-Light** is the light version of the Showcase - the most functionable version of PulseTile-ReactAdmin project. 
...
Showcase-light version has possibility to work **as in multi patient, as in single patient mode**. 
