...
function getCurrentTheme(isContrastMode) {
    ...
    return createMuiTheme({
        ...
        tableHeader: {
            tableHeaderBlock: {
                background: getBackground(isContrastMode, palette.listTemplateHeaderColor, 'tableHeaderImage'),
            },
        },
        patientSummaryPanel: {
            container: {
            ...
            topBlock: {
                background: getBackground(isContrastMode, palette.listTemplateHeaderColor, 'cardBackgroundImage'),
            }
        },
        overrides: {
            MuiInput: {
